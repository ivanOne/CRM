...
<div>
    <div class="form-inline">
        ...
        <?php echo $form->textField($model,'family',array('size'=>20,'class'=>'form-control','value'=>$customer[1])); ?>
        <?php echo $form->error($model,'family'); ?>

        <?php echo $form->labelEx($model,'name'); ?>
        <?php echo $form->textField($model,'name',array('size'=>20,'class'=>'form-control','value'=>$customer[0])); ?>
        <?php echo $form->error($model,'name'); ?>

        <?php echo $form->labelEx($model,'last_name'); ?>
        <?php echo $form->textField($model,'last_name',array('size'=>20,'class'=>'form-control','value'=>$customer[2])); ?>
...
<div>
    ...
    <div id="agent">
        <div class="form-inline">
            ...
            <?php echo $form->textField($model,'family1',array('size'=>20,'class'=>'form-control','value'=>$data->fio->agent?$fio1[1]:false)); ?>
            <?php echo $form->error($model,'family1'); ?>

            <?php echo $form->labelEx($model,'name1'); ?>
            <?php echo $form->textField($model,'name1',array('size'=>20,'class'=>'form-control','value'=>$data->fio->agent?$fio1[0]:false)); ?>
            <?php echo $form->error($model,'name1'); ?>

            <?php echo $form->labelEx($model,'last_name1'); ?>
            <?php echo $form->textField($model,'last_name1',array('size'=>20,'class'=>'form-control','value'=>$data->fio->agent?$fio1[2]:false)); ?>
...
<div>
    ...
    <div class="form-group">
        ...
        <?php echo CHtml::textArea('chat_inp',"",array('class'=>"form-control",'readonly'=>'readonly')); ?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-lg-3">
                <?
                $three = array();
                if($data->three_days != 0){
                    $three['checked'] = 'true';
                }

                ?>
                <?php echo $form->labelEx($model,'three_days'); ?>
                <?php echo $form->checkbox($model,'three_days',$three); ?>
                <?php echo $form->error($model,'three_days'); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-lg-3">
                ...
                ?>
                <?php echo $form->labelEx($model,'six_month'); ?>
                <?php echo $form->checkbox($model,'six_month',$six); ?>
                <?php echo $form->error($model,'six_month'); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-lg-3">
                <?
                $twelf = array();
                if($data->twelfe_month != 0){
                    $twelf['checked'] = 'true';
                }

                ?>
                <?php echo $form->labelEx($model,'twelve_month'); ?>
                <?php echo $form->checkbox($model,'twelve_month',$twelf); ?>
                <?php echo $form->error($model,'twelve_month'); ?>
            </div>
        </div>
    </div>
