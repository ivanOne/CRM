$(document).ready(function(){
    ...
    $("#add").click(function(){
        ...
        $(".inputListU").append(function(){
            ...
            return "<div idn="+count+" class='row'><div class='col-lg-7'><input idn="+count+" placeholder='Название' type='text' class='form-control' name='serviceName[]'></div><div class='col-lg-2'><input idn="+count+" placeholder='Стоимость' type='text' class='form-control' name='servicePrice[]'></div><div idn='"+count+"' id='del' class='col-lg-1 btn btn-danger'>Удалить</div></div>";
        });
    });
    ...
    $("#addU").click(function(){
        $(".inputListU").append(function(){
            ini();
            count++;
            return "<div idn="+count+" class='row'><div class='col-lg-7'>" +
            "<input idn="+count+" placeholder='Название' type='text' class='form-control' name='serviceName[]'></div>" +
            "<div class='col-lg-2'>Скидка<input type='checkbox'></div>" +
            "<div class=col-lg-2><input idn="+count+" placeholder='Стоимость' type='text' class='form-control' name='servicePrice[]'></div>" +
            "<div idn='"+count+"' id='del' class='col-lg-1 btn btn-danger'>Удалить</div></div>";
        });
    });
