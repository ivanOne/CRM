$(document).ready(function(){
    ...
    $("#addU").click(function(){
        $(".inputListU").append(function(){
            ...
            "<input idn="+count+" placeholder='Название' type='text' class='form-control' name='service[][name]'></div>" +
            "<div class='col-lg-2 text-right'><span>Скидка </span><input idn="+count+" name='service[][discount]'  type='checkbox'></div>"+
            "<div class=col-lg-3><input idn="+count+" placeholder='Стоимость' type='text' class='form-control' name='service[][price]'></div>" +
