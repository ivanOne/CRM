$(document).ready(function(){
    ...
    $("#add").click(function(){
        ...
        $(".inputListU").append(function(){
            ...
            return "<div ln='serv' idn="+count+" class='row'><div class='col-lg-7'><input idn="+count+" placeholder='Название' type='text' class='form-control' name='service["+count+"][name]'></div><div class='col-lg-3'><input idn="+count+" placeholder='Стоимость' type='text' class='form-control' name='service["+count+"][price]'></div><div idn='"+count+"' id='del' class='col-lg-2 btn btn-danger'>Удалить</div></div>";
        });
    });
    ...
    $("#addU").click(function(){
        $(".inputListU").append(function(){
            ...
            "<input ln='serv' idn="+count+" placeholder='Название' type='text' class='form-control' name='service["+count+"][name]'></div>" +
